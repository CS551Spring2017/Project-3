...
int (*call_vec[])(void) = {
	...
	do_chmod,	/* 95 = fchmod */
	do_chown,	/* 96 = fchown */
	do_fixzonemap,		/* 97 = unused */
	no_sys,		/* 98 = (sprofile) */
	no_sys,		/* 99 = (cprofile) */
	no_sys,		/* 100 = (newexec) */
	no_sys,		/* 101 = (srv_fork) */
	no_sys,		/* 102 = (exec_restart) */
	do_damagezonemap,		/* 103 = unused */
	no_sys,		/* 104 = (getprocnr) */
	do_fixinodemap,		/* 105 = unused */
	no_sys,		/* 106 = unused */
	no_sys,		/* 107 = (getepinfo) */
	do_directorywalker,		/* 108 = directorywalker */
	do_inodebitmapwalker,	/* 109 = inodebitmapwalker */
	do_zonebitmapwalker,	/* 110 = zonebitmapwalker */
	no_sys,		/* 111 = (srv_kill) */
